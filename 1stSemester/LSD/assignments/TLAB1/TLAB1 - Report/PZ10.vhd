...
begin
    ...
    U0: PZ4
        port map (I0 => I2, I1 => I3, I2 => I4,
        I3 => I5, P => P1_temp, Z => Z1_temp);

    U1: PZ4
        port map (I0 => I6, I1 => I7, I2 => I8,
        I3 => I9, P => P2_temp, Z => Z2_temp);

    U2: PZ4
        port map (I0 => I0, I1 => I1, I2 => P1_temp,
        I3 => P2_temp, P => P_temp, Z => Z3_temp);
