\begin{tikzpicture}
    ...
    \node[input, above of = ffd, xshift = 2.5cm, yshift = 1.5cm,label={[scale=.8]above:(8 bits)}] (x2_i) {$x^2$};
    \node[io] (x2_i_o) at (x2_i.east) {};

    \node[input, above of = ffd, xshift = 5.5cm, yshift = 1.5cm,label={[scale=.8]above:(8 bits)}] (sum_i) {Sum In};
    ...
    \node[output, below of = mux2, yshift = -1cm,label={[scale=.8]below:(8 bits)}] (out_o) {Out};
