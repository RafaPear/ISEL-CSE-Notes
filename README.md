...
- [Semester 3](./3rdSemester):
  ...
  - TDS (Software Development Tecniques)
  - PE (Probabilities and Statistics)

All assignments are within each class folder. Some assignments have a proper GitHub repository such as:
...
| **[LIC Assignment](https://github.com/RafaPear/LIC_grupo1)** | Computer Science Laboratory (LIC) | 2 | Hardware and Software communication, low level | VHDL, Kotlin |
...
> You can find my config files inside the folder [dotFiles](./dotFiles)

### Computers

- Main Computer: Macbook Air M4, 256Gb, 16Gb
- Second Computer: Legion 5, ryzen 7 4800H, RTX 2060, 528Gb, 16Gb
